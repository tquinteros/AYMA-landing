...
const Footer = () => {
    ...
    return (
        <footer className="bg-roca-500 border-t border-primary-500">
            <div className='flex flex-col gap-12 lg:gap-6 px-6 sm:px-8 lg:px-24 py-8 lg:flex-row lg:items-center lg:justify-between'>
                ...
                <div className='flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6'>
                    <a href="mailto:info@aymawellnessclub.com" className='text-background-500 underline hover:opacity-75 duration-300 transition-all text-base break-all text-center'>
